...
class _$UserProfileImpl implements _UserProfile {
  ...
  @override
  String toString() {
    return 'UserProfile(id: $id, age: $age, gender: $gender, illnesses: $illnesses, weight: $weight, height: $height, location: $location, foodPreferences: $foodPreferences, userId: $userId)';
  }
